// LineForm Component - komponen form spesifik untuk line chart dengan multi-sensor selection
    ...
    <div className="flex flex-col gap-2">
      <Label className="text-left ml-1 font-medium">
        ...
        <span className="text-xs text-muted-foreground ml-2">
          (Maksimal {maxSelection} datastream)
        </span>
      </Label>
        ...
        <div className="flex items-center gap-2 p-3 border-2 border-dashed rounded-lg">
          ...
          >
            <SelectTrigger className="flex-1">
              <SelectValue placeholder="Pilih Device & Datastream untuk Line Chart" />
            </SelectTrigger>
            <SelectContent>
              {/* Search Input */}
      ...
      {selectedPairs.length > 0 && (
        <p className="text-xs text-muted-foreground">
          Line chart akan menampilkan tren data sensor dalam bentuk garis yang terhubung.
        </p>
      )}
    </div>
  );
