// AreaForm Component - komponen form spesifik untuk area chart dengan multi-sensor selection
  ...
  return (
    <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2 p-3 border-2 border-dashed rounded-lg">
          ...
          >
            <SelectTrigger className="flex-1">
              <SelectValue placeholder="Pilih Device & Datastream untuk Area Chart" />
            </SelectTrigger>
            <SelectContent>
              {/* Search Input */}
      ...
      {selectedPairs.length > 0 && (
        <p className="text-xs text-muted-foreground">
          Area chart akan menampilkan tren data sensor dalam bentuk area yang terisi.
        </p>
      )}
    </div>
  );
