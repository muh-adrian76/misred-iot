// PieForm Component - komponen form spesifik untuk pie chart dengan multi-sensor selection
    ...
    <div className="flex flex-col gap-4">
      <Label className="text-left ml-1 font-medium">
        ...
        <span className="text-xs text-muted-foreground ml-2">
          (Maksimal {maxSelection} sensor untuk Pie Chart)
        </span>
      </Label>
        ...
        <div className="flex items-center gap-2 p-3 border-2 border-dashed rounded-lg">
          ...
          >
            <SelectTrigger className="flex-1">
              <SelectValue placeholder="Pilih Device & Datastream untuk Pie Chart" />
            </SelectTrigger>
            <SelectContent>
              {/* Search Input */}
      ...
      {selectedPairs.length > 0 && (
        <p className="text-xs text-muted-foreground">
          Pie chart akan menampilkan perbandingan nilai sensor dalam bentuk lingkaran.
        </p>
      )}
    </div>
  );
